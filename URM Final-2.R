...
ggplot(aurm.total.fac, aes(year, percentage))  + 
  ...
  theme_hodp() +
  labs(title="Percentage of URM Students & Tenured and Tenure-Track Faculty") +
  xlab("Year") +
  ylab("Percentage") +
  ylim(0, 25)
...
ggplot(final.urm.dt, aes(x = c(2010:2020), y = percentage), levels = 2010:2020)  +
  ...
  scale_x_continuous(breaks=c(2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020)) +
  theme_hodp() +
  labs(title="URM FAS Tenured and Tenure-Track Faculty Percentage") +
  xlab("Year") +
  ylab("Percentage") +
  ylim(0, 17)
grid::grid.raster(logo, x = 0.01, y = 0.01, just = c('left', 'bottom'), width = unit(1.5, 'cm'))
