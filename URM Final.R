...
h = ggplot(final.urm.dt, aes(x = c(2010:2020), y = percentage), levels = 2010:2020) +
...
h + scale_x_continuous(breaks=c(201000, 201100, 201200, 201300, 201400, 201500, 201600, 201700, 201800, 201900, 202000), 
  ...
  labs(title="URM FAS Tenure and Tenure-Track Faculty Percentage") +
  xlab("Year") +
  ylab("Percentage") +
  labs(color='FAS Dept') +
  theme_hodp ()
